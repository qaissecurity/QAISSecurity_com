...
(function(){
  ...
  var alertMsgs=[
    ...
    {text:'Quantum circuit diagnostic passed — WuKong 180: 72 active qubits coherent',color:'var(--purple)'},
  ...
  window.qccStatClick=function(stat){
    ...
    var panels={
      ...
      qubits:'<h3 style="color:var(--purple);margin:0 0 12px">180 Qubits — WuKong 180</h3><div style="font-size:.7rem;color:var(--muted);line-height:1.8"><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>Active Qubits</span><span style="color:var(--purple);font-family:var(--mono)">72 / 180</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>Coherence Time</span><span style="font-family:var(--mono)">~100\u03BCs</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>Gate Fidelity</span><span style="color:#22c55e;font-family:var(--mono)">99.73%</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>Processor</span><span style="font-family:var(--mono)">OriginQ WuKong 180</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>Temperature</span><span style="color:var(--blue);font-family:var(--mono)">15 mK</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>SDK</span><span style="font-family:var(--mono)">pyqpanda3 v0.3.4</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.04)"><span>API Status</span><span style="color:#22c55e;font-family:var(--mono)">Authenticated \u2713</span></div><div style="display:flex;justify-content:space-between;padding:6px 0"><span>Qubit Mapping</span><span style="font-family:var(--mono);font-size:.55rem">QRNG[1-20] Anom[38-41] Bell[44-45]</span></div></div>',
